import type { ReportEvidenceFile } from '@/types/report'

interface ReportEvidenceSectionProps {
  title: string
  files?: ReportEvidenceFile[] | null
}

export function ReportEvidenceSection({ title, files }: ReportEvidenceSectionProps) {
